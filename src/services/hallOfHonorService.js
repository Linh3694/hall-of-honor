 ...
 */
export const getAwardRecords = async (filters = {}) => {
  try {
 ...
 */
export const getAwardRecordDetail = async (recordId) => {
  try {
 ...
 * }
 */
const normalizeCategory = (frappeCategory) => {
  return {
 ...
 * }
 */
const normalizeSubCategory = (frappeSubCategory) => {
  return {
 ...
 */
const normalizeRecord = (frappeRecord) => {
 ...
 */
const normalizeStudent = (frappeStudent) => {
  return {
    student: frappeStudent.student ? {
      _id: frappeStudent.student.name || "",
 ...
 */
const normalizeClass = (frappeClass) => {
  return {
 ...
 * }
 */
const normalizeSchoolYear = (frappeSchoolYear) => {
